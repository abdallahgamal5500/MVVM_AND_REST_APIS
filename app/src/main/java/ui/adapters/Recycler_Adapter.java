...
public class Recycler_Adapter extends RecyclerView.Adapter<Recycler_Adapter.PostViewHolder> {
    private List<Model> arrayList = new ArrayList<>();

    @NonNull
    @Override
    public PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PostViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_design, parent, false));
    }
